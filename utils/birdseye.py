from utils.helper import show_dotted_image
import cv2 
import numpy as np 
...
class BirdsEye:
  ...
  def project(self, ground_image, sky_lane, left_fit, right_fit, color = (125, 244, 66)):
    ...
    result = cv2.addWeighted(ground_image, 1, ground_lane, 0.8, 0)
    return ground_lane